/*
|-----------------------------------------
| setting up Style for the App
| @author: Toufiquer Rahman<toufiquer.0@gmail.com>
| @copyright: Toufiquer, May, 2024
|-----------------------------------------
*/
const commonStyle = " font-semibold text-slate-500";
export const webAppTextSM = ` text-sm ${commonStyle}`;
export const webAppH2 = ` [18px] ${commonStyle}`;
